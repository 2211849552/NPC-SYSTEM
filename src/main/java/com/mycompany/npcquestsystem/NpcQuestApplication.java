...
public final class NpcQuestApplication {
    ...
    public static void main(String[] args) {
        ...
        Npc quartermaster = new Npc("npc_qm", "Quartermaster Hale", new NeutralDialogueStrategy());
        Npc scout = new Npc("npc_scout", "Scout Rin", new FriendlyDialogueStrategy());
        Npc deserter = new Npc("npc_deserter", "Deserter Voss", new HostileDialogueStrategy());

        Quest recon = new Quest("q_recon", "Recon the ridge", "Survey enemy positions and return.");

        printSection("Greetings (each NPC uses a different DialogueStrategy)");
